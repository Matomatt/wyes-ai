...
class Mouvements(tk.Frame):
    ...
    def init(self):
        ...
        for i in range(nbMov):
            ...
            self.mouvementButtons[i].configure(fg='white', bg='white', overrelief=tk.FLAT, relief=tk.FLAT, compound="center", font='Montserrat')
        ...
        self.addMovementButton.configure(fg='white', bg='white', overrelief=tk.FLAT, relief=tk.FLAT, font='Montserrat 10 bold')
    ...
    def addMovement(self):
        ...
        for i in range(newIndex):
            self.can[i] = tk.Canvas(self, bg='white')
            ...
            self.mouvementButtons[i].configure(fg='white', bg='white', overrelief=tk.FLAT, relief=tk.FLAT,
                                               compound="center", font='Montserrat')
            if newIndex>4:
                self.mouvementButtons[i].configure(font="Montserrat "+str(20-2*newIndex))
            self.mouvementButtons[i].pack(in_=self, side=tk.LEFT, padx=5, pady=5)

        self.can.append(tk.Canvas(self, bg='white'))
        ...
        self.mouvementButtons[newIndex].configure(fg='white', bg='white', overrelief=tk.FLAT, relief=tk.FLAT,
                                           compound="center", font='Montserrat')
        if newIndex>4:
