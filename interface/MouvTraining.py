...
class MouvTraining(tk.Frame):
    ...
    def mouv(self):
        ...
        self.bm1 = tk.Button(self, text="Mouvement 1", width=33, height=45, command=self.trainmouv1)
        self.bm2 = tk.Button(self, text="Mouvement 2", width=33, height=45, command=self.trainmouv2)
        self.bm3 = tk.Button(self, text="Mouvement 3", width=33, height=45, command=self.trainmouv3)
